    ...
    def get(self, record,video_list, indices,decode_boo):
        ...
        for seg_ind in indices:
            ...
            for i in range(0,self.new_length,1):
                ...
                RGB_IMAGES_path.append(self.root_path + record.path + '/' + self.image_tmpl.format(p))
        ...
        #print('dataset',process_data.shape)
        return process_data, record_label#, RGB_IMAGES_path
